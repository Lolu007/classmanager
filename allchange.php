...
error_reporting(E_ALL ^ E_NOTICE);
		...
		$pager = new PS_Pagination($db2->getConnection(),"SELECT * FROM payments WHERE s_change!=0 AND material_Id = '".$_GET['materialId']."' order by datepaid desc",64,3);
		$rs = $pager->paginate();
...
<title>::CLASS MANAGER v1.0::VIEWING STUDENTS HAVING BALANCE TO COLLECT</title>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
						  ...
						  <table width="100%" cellpadding="2" cellspacing="1">
                            ...
                            <tr>
                              <td colspan="8" align="center"><div id="commonhdn">LIST OF STUDENTS TO COLLECT BALANCE</div></td>
                            </tr>
                            <tr>
                            ...
                            <tr align="center" valign="middle" class="tableheader">
							  ...
							  <td width="16%"><span class="style9">CHANGE(NAIRA)</span></td>
                            ...
                            <tr class="<?php echo $class;?>">
                              ...
                              <td align="center" valign="middle"><span class="style5"><a href="editstudent.php?adminstatus=<?php echo base64_encode($adminstatus);?>&amp;user=<?php echo base64_encode($user);?>&amp;name=<?php echo base64_encode($name);?>&amp;materialId=<?php echo $material['material_id'];?>&amp;matric=<?php echo $row['student_matric']; ?>" title="Manage this student's payment" class="style2"><?php echo $row['student_matric']; ?></a></span></td>
							  ...
							  <td align="center" valign="middle"><span class="style5"><?php echo $row['s_change'].".00"; ?></span></td>
