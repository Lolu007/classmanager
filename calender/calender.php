...
<table style="width: 105px; border-collapse: collapse;" border="1" cellpadding="3" cellspacing="0"
    ...
    <tr style="background: #FFBC37;">
        <td colspan="7" style="text-align: center;" onmouseover="this.style.background='#FECE6E'"
            onmouseout="this.style.background='#FFBC37'"><span
                    style="font-weight: bold;"><?php echo $monthName . " " . $year; ?></span></td>
    </tr>
    <tr style="background: #FFBC37;">
    ...
    for ($k = 1; $k <= $numrows; $k++)//for 1
    {
        ...
        for ($i = 0; $i < 7; $i++)//for 2
        {
            ...
            } else//2
            {
                ...
                {
                    ?>
                    <td style="text-align: center; background: #A2BAFA;" onmouseover="this.style.background='#CAD7F9'"
