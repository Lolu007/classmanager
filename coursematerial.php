...
error_reporting(E_ALL ^ E_NOTICE);
		...
		$sqlh="SELECT * FROM courses Order by coursecode";
...
<title>::CLASS MANAGER v1.0::CREATING MATERIAL</title>
                                        ...
                                        <tr>
                                          <td><form id="form1" name="form1" method="post" action="">
                                              <table width="100%" border="0" cellpadding="4" cellspacing="4">
                                                <tr>
                                                  <td colspan="2" align="left"><div id="hdline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Creating Material</div></td>
                                                </tr>
                                                <?php if(isset($info)){?>
                                                <tr>
                                                  ...
                                                  <td colspan="2"><fieldset>
                                                    ...
                                                    <table width="100%">
                                                      <tr>
                                                        ...
                                                        <td width="67%" valign="top">                                                          <select name="course" id="course">
                                                            <option value="">--select course--</option>
															 <?php do { ?>
																	  <option value="<?php echo $rsh['coursecode']; ?>"><?php echo $rsh['coursecode']; ?></option>
																	  <?php } while ($rsh=mysql_fetch_assoc($resh)); ?>
                                                          </select>														 </td>
                                                      </tr>
                                                      <tr>
                                                        <td width="33%" align="left" class="tblabel">Number of Pages:</td>
                                                        <td width="67%"><input type="text" name="pages" id="pages" onkeyup="getTotal();"/></td>
                                                      </tr>
                                                      <tr>
                                                        <td width="33%" align="left" class="tblabel">Price per page</td>
                                                        <td width="67%">
															<select name="price" id="price" onchange="getTotal();">
																<option value="">--select price--</option>
																<option value="3" selected="selected">3 naira</option>
																<option value="4">4 naira</option>
															</select>
														</td>
                                                      </tr>
													  ...
													  <tr>
                                                        ...
                                                        <td width="67%"><br /><input type="text" name="totalcost" id="totalcost" disabled="disabled"/></td>
                                                      </tr>
                                                    </table>
                                                    </fieldset>
                                                      <br />
                                                ...
                                                <tr>
                                                  <td width="34%">&nbsp;</td>
                                                  <td width="66%"><input type="submit" title="Create Material" name="create" id="create" value="Submit"/></td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2"><hr />
                                                    &nbsp;</td>
