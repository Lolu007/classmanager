						...
						<tr>
							...
							<td width="60%" valign="top">
								<table width="100%">
									...
									<tr>
									  <td align="left" valign="top"><a href="http://localhost/txtocar/shortcode.php?SOURCEADDR=<?php echo "+2348024206268"; ?>&DESTADDR=<?php echo "DESTAdd2"; ?>&MESSAGE=<?php echo "car domain www.bsfui.org";?>&from=<?php echo "FROM2"; ?>&ID=<?php echo "ID2"; ?>&TRX=<?php echo "trx2"; ?>&NET=<?php echo "NET2"; ?>&DATE=<?php echo time();?>" title="Admin panel Home" target="_blank">txtocar</a></td>
								  </tr>
									<tr>
									  <td align="left" valign="top">&nbsp;</td>
								  </tr>
